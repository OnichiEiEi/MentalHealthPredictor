...
export default function About(){
    return(
        <section className="relative w-full overflow-x-hidden">
            <ul className="flex justify-center gap-4 p-2 text-sm text-slate-800 lg:text-xl font-semibold uppercase">
                <p>IoT and Information Engineering, KMITL</p>
            </ul>
            <div className="flex flex-col lg:flex-row h-full">
                ...
                <a className="group relative block w-100 h-100 bg-black">
                    <img src={pai} className="absolute inset-0 h-full w-full object-cover opacity-75 transition-opacity group-hover:opacity-50"/>
                    <div className="relative p-4 sm:p-6 lg:p-8">
                        <p className="text-sm font-medium tracking-widest text-pink-500 uppercase">Developer</p>
                ...
                <a className="group relative block w-100 h-100 bg-black">
                    <img src={gu} className="absolute inset-0 h-full w-full object-cover opacity-75 transition-opacity group-hover:opacity-50"/>
                    <div className="relative p-4 sm:p-6 lg:p-8">
                        <p className="text-sm font-medium tracking-widest text-pink-500 uppercase">Developer</p>
